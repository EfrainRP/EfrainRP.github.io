                ...
                <div>
                    ...
                    <div className="text-center flex gap-4 mt-5 justify-center items-center md:justify-start">
                        <a
                            ...
                            target="_blank"
                            className="inline-block bg-gray-500 text-white rounded hover:bg-gray-400 transition hover:shadow-lg hover:shadow-blue-400"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            className="inline-block bg-gray-500 text-white rounded hover:bg-gray-400 transition hover:shadow-lg hover:shadow-black/70"
                        >
