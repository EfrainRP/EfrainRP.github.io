...
export default function Hero() {
    ...
    return (
        <section className="pt-32 pb-20 bg-gradient-to-b from-blue-50 to-white text-center animate-fade-in">
            ...
            />
            <h1 className="mt-6 text-4xl font-extrabold text-blue-700">Efrain Robles</h1>
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width="35" height="35" viewBox="0 0 24 24"><path fill="#FFFFFF" d="M21,21H17V14.25C17,13.19 15.81,12.31 14.75,12.31C13.69,12.31 13,13.19 13,14.25V21H9V9H13V11C13.66,9.93 15.36,9.24 16.5,9.24C19,9.24 21,11.28 21,13.75V21M7,21H3V9H7V21M5,3A2,2 0 0,1 7,5A2,2 0 0,1 5,7A2,2 0 0,1 3,5A2,2 0 0,1 5,3Z" /></svg>
            </a>
            <a
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"><path fill="#000000" 
            ...
            <a 
                ...
                className="mt-3 p-2 inline-block text-white rounded bg-blue-600 hover:bg-blue-500 transition"
