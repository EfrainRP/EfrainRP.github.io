                    ...
                    <div className="relative border-l border-gray-200">
                        ...
                        >
                            ...
                            <div className="backdrop-blur-md bg-white/40 border border-white/60 shadow-md rounded-xl p-5 hover:shadow-lg hover:scale-[1.03] transition-transform duration-300">
                                <div>
                                    <h3 className="text-lg font-semibold mb-2">AiSport - Tournaments Manager Web App</h3>
                                    {/* <span className="text-sm text-gray-400">2025</span> */}
                                    <Accordion title="Description" className='md:w-3xl'>
                                ...
                                <div className="text-sm text-gray-500 my-4">Technologies used:</div>
                                <Carousel images={['HTML5','CSS3','JavaScript','React','MaterialUI','Axios', 'Node.js','MySQL','Prisma','Git','Railway','Python', 'OpenCV']}/>
                                <div className='flex space-x-4 justify-center'>
                                    <a
                                        href="https://github.com/EfrainRP/AiSportFrontend.git"
                                        target="_blank"
                                        className="flex justify-center items-center px-2 bg-blue-500 rounded hover:bg-gray-400 transition shadow-lg shadow-blue-500/50 hover:shadow-lg"
                                    >
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        className="flex justify-center items-center px-2 bg-yellow-500 rounded hover:bg-gray-400 transition shadow-lg shadow-yellow-500/50 hover:shadow-lg"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="#000000" 
                                            d="M12,2C6.48,2 2,6.58 2,12.26C2,16.74 4.87,20.52 8.84,21.78C9.34,21.87 9.5,21.55 9.5,21.27C9.5,21.02 9.49,20.39 9.49,19.7C6.73,20.34 6.14,18.42 6.14,18.42C5.68,17.29 5.03,16.97 5.03,16.97C4.12,16.34 5.1,16.36 5.1,16.36C6.1,16.43 6.63,17.48 6.63,17.48C7.5,19 8.97,18.55 9.54,18.27C9.63,17.6 9.9,17.14 10.2,16.89C7.94,16.63 5.58,15.76 5.58,11.9C5.58,10.8 5.97,9.91 6.64,9.22C6.53,8.96 6.17,7.87 6.74,6.41C6.74,6.41 7.59,6.12 9.49,7.42C10.29,7.18 11.15,7.06 12,7.06C12.85,7.06 13.71,7.18 14.51,7.42C16.41,6.12 17.26,6.41 17.26,6.41C17.83,7.87 17.47,8.96 17.36,9.22C18.03,9.91 18.42,10.8 18.42,11.9C18.42,15.77 16.06,16.62 13.8,16.88C14.19,17.2 14.54,17.85 14.54,18.84C14.54,20.3 14.53,21.39 14.53,21.27C14.53,21.55 14.69,21.87 15.19,21.78C19.16,20.52 22,16.74 22,12.26C22,6.58 17.52,2 12,2Z" 
                                        />
                                ...
                                <a
                                        ...
                                        target="_blank"
                                        className="flex justify-center items-center mx-auto md:mx-75 px-2 mt-3 bg-purple-400 rounded hover:bg-gray-400 transition shadow-lg shadow-purple-400/50 hover:shadow-lg"
                                    >
                                        <img
                                        ...
                                        />
                                        <span className="ml-2">Info on CUCEI</span>
                                    </a>
                            </div>
                        </motion.div>
                        {/* ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
                        ...
                        >
                            ...
                            <div className="backdrop-blur-md bg-white/40 border border-white/60 shadow-md rounded-xl p-5 hover:shadow-lg hover:scale-[1.03] transition-transform duration-300">
                                <div>
                                    <h3 className="text-lg font-semibold mb-2">Optimal Route Finder</h3>
                                    {/* <span className="text-sm text-gray-400">2025</span> */}
                                    <Accordion title="Description" className='md:w-3xl' classNameChildren= "flex flex-col justify-between items-center py-2">
                                ...
                                <Carousel images={['Python', 'OpenCV']}/>

                                <a
                                    href="https://github.com/EfrainRP/SeminarioDeAlgoritmia/tree/main/ACT9"
                                    target="_blank"
                                    className="w-30 mx-auto mt-8 flex justify-center items-center px-2 bg-blue-500 rounded hover:bg-gray-400 transition shadow-lg shadow-blue-500/50 hover:shadow-lg"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="#000000" 
                                        d="M12,2C6.48,2 2,6.58 2,12.26C2,16.74 4.87,20.52 8.84,21.78C9.34,21.87 9.5,21.55 9.5,21.27C9.5,21.02 9.49,20.39 9.49,19.7C6.73,20.34 6.14,18.42 6.14,18.42C5.68,17.29 5.03,16.97 5.03,16.97C4.12,16.34 5.1,16.36 5.1,16.36C6.1,16.43 6.63,17.48 6.63,17.48C7.5,19 8.97,18.55 9.54,18.27C9.63,17.6 9.9,17.14 10.2,16.89C7.94,16.63 5.58,15.76 5.58,11.9C5.58,10.8 5.97,9.91 6.64,9.22C6.53,8.96 6.17,7.87 6.74,6.41C6.74,6.41 7.59,6.12 9.49,7.42C10.29,7.18 11.15,7.06 12,7.06C12.85,7.06 13.71,7.18 14.51,7.42C16.41,6.12 17.26,6.41 17.26,6.41C17.83,7.87 17.47,8.96 17.36,9.22C18.03,9.91 18.42,10.8 18.42,11.9C18.42,15.77 16.06,16.62 13.8,16.88C14.19,17.2 14.54,17.85 14.54,18.84C14.54,20.3 14.53,21.39 14.53,21.27C14.53,21.55 14.69,21.87 15.19,21.78C19.16,20.52 22,16.74 22,12.26C22,6.58 17.52,2 12,2Z" 
                                    />
