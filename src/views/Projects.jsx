                            ...
                            <div className="backdrop-blur-md bg-white/40 border border-white/60 shadow-md rounded-xl p-5 hover:shadow-lg hover:scale-[1.03] transition-transform duration-300">
                                <div className="flex items-center mb-3 md:justify-start">
                                    ...
                                    <div>
                                        ...
                                        {/* <span className="text-sm text-gray-400">2025</span> */}
                                        <Accordion title="Description" className='md:w-3xl' classNameChildren= "flex flex-col space-x-6 md:space-x-6 md:space-y-4 space-y-4 justify-between items-center py-2 text-gray-600">
                                            <p className="text-sm text-gray-500 text-justify leading-relaxed">
