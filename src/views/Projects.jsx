                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="relative border-l border-gray-200">
                        ...
                        >
                            ...
                            <div className="backdrop-blur-md bg-white/40 border border-white/60 shadow-md rounded-xl p-5 hover:shadow-2xl hover:scale-[1.03] transition-transform duration-300">
                                <div>
                                    <h3 className="text-lg font-semibold mb-2">AiSport - Basquet-Ball Tournaments Manager Web App</h3>
                                ...
                                <div className='flex gap-2 md:gap-4 mt-2 justify-center'>
                                    ...
                                    <a 
                                        ...
                                        target="_blank"
                                    >
                                        <svg className="w-5 h-5 mr-2 inline-block text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        >
                            ...
                            <div className="backdrop-blur-md bg-white/40 border border-white/60 shadow-md rounded-xl p-5 hover:shadow-2xl hover:scale-[1.03] transition-transform duration-300">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    className="w-30 mx-auto mt-2 flex justify-center items-center p-1 text-xs md:text-base bg-blue-500 rounded transition shadow-lg hover:bg-gray-400 shadow-blue-500/50 hover:bg-gray-400 hover:shadow-lg hover:shadow-gray-500"
                                >
