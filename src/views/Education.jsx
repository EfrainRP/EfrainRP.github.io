...
export default function Education() {
    return (
        <Layout className="bg-gradient-to-b from-gray-50 to-white text-gray-800">
            ...
            <div className="max-w-4xl mx-auto my-25 animate-slideLeft">
                <h2 className="text-3xl font-bold text-center mt-25 mb-10">Education</h2>

                <div className="max-w-4xl space-y-8 px-6 mx-auto">
                    {/* CUCEI */}
                    <motion.div
                        className="realtive bg-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition-shadow duration-300"
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400">GPA 9.9</p>

                            </div>
                        </div>
                        <p className="text-gray-500 text-justify mt-2 mx-5 md:mx-5">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4 md:gap-8">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400">GPA 9.6</p>
